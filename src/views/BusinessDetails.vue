...
export default {
      ...
      this.$axios({
        ...
        .then(x => {
          ...
          if (x.data.code == 200) {
            ...
            var img_list = x.data.data.environmentalImg
              ? x.data.data.environmentalImg.split(",")
              : [];
            ...
            if (this.isfenxiang) {
              if (this.$route.query.userid) {
                localStorage.yaoqing =
                  "#/Recommend?pid=" +
                  this.$route.query.userid +
                  "&invitationtype=2";
              } else {
                localStorage.yaoqing =
                  "#/Recommend?pid=" + this.shop.userid + "&invitationtype=2";
              }
            }
          }
        })
  ...
  mounted: function() {
    ...
    this.hongbaoid = this.$route.query.hongbaoid
      ? this.$route.query.hongbaoid
      : "";
    ...
    if (this.userInfo) {
      ...
      Promise.all([this.get_hongbao(), this.findEffective()]).then(res => {
        ...
        var lignqu_honghao =
          res[1].data.code == 200 ? res[1].data.data.data : []; //领取的红包
            ...
            if (this.isfenxiang && this.state_isfenxiang) {
              if (this.lingqu) {
                ...
                if (this.fenxiang_hongbao.type == 1) {
                  this.set_isfenxiang();
                  this.$router.push(
                    "/commodity/CommodityDetails?id=" +
                      this.fenxiang_hongbao.commodityId
                  );
                }
              } else {
                //显示红包弹出框
    ...
    if (
      ...
      this_1.$store.state.my_position.x == ""
    ) {
      try {
