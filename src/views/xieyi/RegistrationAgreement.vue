<template>
    <div id="RegistrationAgreement">
        <header class="mui-bar mui-bar-nav">
            ...
            <h1 class="mui-title">用户注册协议</h1>
        </header>
        <div class="mui-content">
            <ul class="box_1">
                <li class="title_1"> 一、总则</li>
                <li class="text_1">1.1 红包乐购的所有权和运营权归在易起科技成都有限公司所有。 </li>
                <li class="text_1">
                    1.2 用户在注册之前，应当仔细阅读本协议，并同意遵守本协议后方可成为注册用户。一旦注册成功，则用户与红包乐购之间自动形成协议关系，用户应当受本协议的约束。用户在使用特殊的服务或产品时，应当同意接受相关协议后方能使用。  
                </li>
                <li class="text_1">
                    1.3 本协议则可由红包乐购随时更新，用户应当及时关注并同意本站不承担通知义务。本站的通知、公告、声明或其它类似内容是本协议的一部分。 
                </li>
                <li class="title_1">
                    二、服务内容
                </li>
                <li class="text_1">
                    2.1 红包乐购的具体内容由本站根据实际情况提供。 
                </li>
                <li class="text_1">
                ...
                <li class="text_1">
                    3.1 经本站注册系统完成注册程序并通过身份认证的用户即成为正式用户，可以获得本站规定用户所应享有的一切权限；未经认证仅享有本站规定的部分会员权限。红包乐购有权对会员的权限设计进行变更。 
                </li>
                <li class="text_1">
            ...
            5.1 本站不对外公开或向第三方提供单个用户的注册资料及用户在使用网络服务时存储在本站的非公开内容，但下列情况除外：
                ...
                <li class="text_1">
                6.1 本站的文字、图片、音频、视频等版权均归成都在易起科技有限公司享有或与作者共同享有，未经本站许可，不得任意转载。 
                </li>
                <li class="text_1">
                6.2 本站特有的标识、版面设计、编排方式等版权均属成都在易起科技有限公司享有，未经本站许可，不得任意复制或转载。  
                </li>
                <li class="text_1">
                6.3 使用本站的任何内容均应注明“来源于红包乐购”及署上作者姓名，按法律规定需要支付稿酬的，应当通知本站及作者及支付稿酬，并独立承担一切法律责任。
                </li>
                <li class="text_1">
                ...
                <li class="text_1">
                7.1 用户明确同意其使用本站网络服务所存在的风险及一切后果将完全由用户本人承担，红包乐购对此不承担任何责任。 
                </li>
                <li class="text_1">
                ...
                <li class="text_1">
                 7.6 本站有权于任何时间暂时或永久修改或终止本服务(或  其任何部分)，而无论其通知与否，本站对用户和任何第三人均无需承担任何责任。
                </li>
                <li class="title_1"> 八、附则</li>
                <li class="text_1">
...
#RegistrationAgreement .mui-title {
  color: #ffffff;
}
#RegistrationAgreement .swiper-pagination-bullet-active {
  background: rgba(39, 172, 110, 1);
}
#RegistrationAgreement .box_1 {
  padding: 0.1rem;
  .title_1 {
    font-weight: bold;
    margin: 5px 0px;
