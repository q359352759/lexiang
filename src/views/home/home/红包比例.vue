...
export default {
    ...
    mounted () {
        ...
        if(this.max){
            ...
            比例=this.lingqu ? (this.lingqu/300>0.98 ? 0.98 : this.lingqu/300) : 0
        }
        // console.log(this.lingqu,this.max,比例)

		context.beginPath();
		context.arc(w/2, w/2, width/2, Math.PI*0.5+0.4, Math.PI*2.5-0.4 , false);
        ...
        // console.log(Math.PI*2.5-0.4,Math.PI*0.5+0.4+(Math.PI*2-0.8)*比例,Math.PI*0.5+0.4)
                                                            // Math.PI*2.5-0.4
		context.arc(w/2, w/2, width/2, Math.PI*0.5+0.4, Math.PI*0.5+0.4+(Math.PI*2-0.8)*比例 , false);
