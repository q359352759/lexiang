...
const toubu = resolve => {
  require.ensure([], () => {
    resolve(require("./components/头部.vue"));
  });
};
const xuanxiang = resolve => {
  require.ensure([], () => {
    resolve(require("./components/中间选项.vue"));
  });
};
const dianpufenrun = resolve => {
  require.ensure([], () => {
    resolve(require("./components/店铺分润.vue"));
  });
};
const huiyuanfenrun = resolve => {
  require.ensure([], () => {
    resolve(require("./components/会员分润.vue"));
  });
};
const ketixian = resolve => {
  require.ensure([], () => {
    resolve(require("./components/可提现.vue"));
  });
};
const mimashurukuang = resolve => {
  require.ensure([], () => {
    resolve(require("./components/密码输入框.vue"));
  });
};
const xingmingshuru = resolve => {
  require.ensure([], () => {
    resolve(require("./components/姓名输入框.vue"));
  });
};
