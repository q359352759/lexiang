                ...
                <div class="box_1">
                    <ul class="mui-table-view">
                        <li class="mui-table-view-cell item">
                            ...
                            <input type="text" placeholder="请输入店员手机号码" v-model="店员.clerksphone" pattern="^[1][0-9]{10}"  required/>
                        </li>
                        <li class="mui-table-view-cell item">
                            <div class="title">昵称：</div>
                            <input type="text" placeholder="请输入店员昵称" v-model="店员.clerksname" setCustomValidity="132" pattern="^[\s\S]*.*[^\s][\s\S]*" required/>
                        </li>
                        <li class="mui-table-view-cell " @click="选择班次()">
                            <a class="mui-navigate-right item">
                                <div class="title">班次：</div>
                                <input type="text" placeholder="请选择班次" :value="显示班次名称" readonly/>
                            </a>
                        </li>
                    </ul>
                </div>
                <div class="box_2">
                    <btn type="submit" value="添加"/>
                </div>
            </form>
        </div>
