  ...
  methods: {
    ...
    wenhao() {
      ...
      if (this.type == 0) {
        ...
        html =
          '<div style="color:#777777">红包金额为商品的可抵扣金额，不可修改</div>';
      } else if (this.type == 2) {
        html =
          '<div style="color:#777777">根据促销商品的可抵扣金额来计算，建议红包金额大一些，对消费者更有吸引力！红包再大依然遵循可抵扣金额，带来的营业额也更多。</div>';
      } else if (this.type == 4) {
        html =
          "<div style='color:#777777'>根据促销商品的可抵扣金额来计算，建议红包金额大一些，对消费者更有吸引力！红包再大依然遵循可抵扣金额，带来的营业额也更多。</div>";
      } else if (this.type == 5) {
        html =
          "<div style='color:#777777'>如果有发布生日专享商品，根据生日专享商品可抵扣金额计算，否则根据几款普通商品的可抵扣金额计算，建议红包大一些。红包再打大然遵循可抵扣金额，但能购给消费者留下较好印象。</div>";
      }
