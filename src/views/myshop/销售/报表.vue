...
export default {
  ...
  methods: {
    ...
    查询某月的每天营业额() {
      ...
      this.$axios
        .get(
          "/api-s/shops/orders/sumThisMonthAllDay?shopid=" +
            this.myshop.shopid +
            "&startDay=" +
            this.月份.startDay +
            "&endDay=" +
    ...
    查询某年每月() {
      ...
      return new Promise((resolve, reject) => {
        this.$axios
          .get(
            "/api-s/shops/orders/sumTurnoverThisYears?shopid=" +
              this.myshop.shopid +
              "&years=" +
              this.年
          )
    ...
    查询某年的总营业额() {
      this.年报.forEach(item => {
        this.$axios
          .get(
            "/api-s/shops/orders/sumSomeYearTurnover?shopid=" +
              this.myshop.shopid +
              "&years=" +
              item.year
          )
