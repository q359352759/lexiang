    ...
    methods: {
        ...
        Sure() {
            ...
            if (!this.新人红包.headline) {
                ...
                !number_test.test(this.新人红包.amount) ||
                this.新人红包.amount < 0
            ) {
                ...
                if (
                    !this.新人红包.percentage ||
                    !number_test.test(this.新人红包.percentage) ||
                    this.新人红包.percentage > 100
                ) {
                ...
                if (
                    !this.新人红包.expire ||
                    !number_test.test(this.新人红包.expire) ||
                    !this.新人红包.deduction ||
                    !number_test.test(this.新人红包.deduction)
                ) {
