...
export default {
    ...
    methods: {
        ...
        修改推荐人(e, key) {
            ...
            if (phone_test.test(phone)) {
                openloading(true);
                this.get_agentUser_phone(phone)
                    .then(x => {
                        console.log(x);
                        if (x.data.code == 200) {
        ...
        添加() {
            ...
            if (this.推荐人 && this.推荐人.areaCode == this.店铺.areaCode) {
                ...
                this.用户推荐人 &&
                this.用户推荐人.areaCode == this.店铺.areaCode
            ) {
        ...
        添加红包() {
            ...
            var this_1 = this;
            this.$axios
                .post("/api-s/shops/redenvelope/add", this.新人红包)
                .then(x => {
                    console.log(x);
                    if (x.data.code == 200) {
                        mui.alert(
        ...
        修改红包() {
            ...
            var this_1 = this;
            this.$axios
                .post("/api-s/shops/redenvelope/update", this.新人红包)
                .then(x => {
                    if (x.data.code == 200) {
                        mui.alert(
                            "提交成功，等待审核。",
    ...
    mounted: function () {
        ...
        if (
            ...
            this.userInfo.shareid &&
            this.userInfo.referrerid == this.userInfo.shareid
        ) {
            //查询推荐人
            this.查询代理人(this.userInfo.referrerid)
                .then(x => {
        ...
        this.获取店铺().then(() => {
            ...
            if (this.myshop && this.myshop.shopid) {
                ...
                this.$axios
                    .get("/api-s/shops/redenvelope/" + this.myshop.shopid)
                    .then(x => {
