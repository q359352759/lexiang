const ApplicationDistribution = () =>
  import("@/views/myshop/distribution/ApplicationDistribution.vue"); //申请 开通分销功能

// 营销
// 红包发放记录
const RedPacketRecords = () =>
  import("@/views/myshop/Marketing/RedPackets/RedPacketRecords.vue"); //申请 开通分销功能
...
const 会员消费记录 = resolve => {
  require.ensure([], () => {
    resolve(require("@/views/myshop/Member/会员消费记录.vue"));
  });
}; //会员消费记录
...
const 提现 = resolve => {
  require.ensure([], () => {
    resolve(require("@/views/myshop/提现.vue"));
  });
};
const 提现记录 = resolve => {
  require.ensure([], () => {
    resolve(require("@/views/myshop/提现记录.vue"));
  });
};
...
const 销售 = resolve => {
  require.ensure([], () => {
    resolve(require("@/views/myshop/销售/销售.vue"));
  });
};
const 订单详情 = resolve => {
  require.ensure([], () => {
    resolve(require("@/views/myshop/销售/订单详情.vue"));
  });
}; //订单详情
const 报表 = resolve => {
  require.ensure([], () => {
    resolve(require("@/views/myshop/销售/报表.vue"));
  });
}; //报表
...
const 申请开店 = resolve => {
  require.ensure([], () => {
    resolve(require("@/views/申请开店/申请开店.vue"));
  });
};
const 百度地图 = resolve => {
  require.ensure([], () => {
    resolve(require("@/views/申请开店/百度地图.vue"));
  });
};
const 营业时间 = resolve => {
  require.ensure([], () => {
    resolve(require("@/views/申请开店/营业时间.vue"));
  });
};
const 法人认证 = resolve => {
  require.ensure([], () => {
    resolve(require("@/views/申请开店/法人认证.vue"));
  });
};
const 营业执照 = resolve => {
  require.ensure([], () => {
    resolve(require("@/views/申请开店/营业执照.vue"));
  });
};
const 新人红包 = resolve => {
  require.ensure([], () => {
    resolve(require("@/views/申请开店/新人红包.vue"));
  });
};
const 店铺预览 = resolve => {
  require.ensure([], () => {
    resolve(require("@/views/申请开店/店铺预览.vue"));
  });
};
